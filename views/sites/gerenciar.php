                    ...
                    <table class="table form-control table-responsive">
                        ...
                        <?php foreach ($sites as $r) : ?>
                            <tr>
                                ...
                                <a class ="btn btn-default" href="<?php echo BASE_URL.'sites/edit/'.$r['id']; ?>"><i class="fa fa-edit"></i> Editar</a>
                                <!-- <a class ="btn btn-primary" href="<?php echo BASE_URL.'sites/preencher/'.$r['id']; ?>"><i class="fa fa-tint"></i> </a> -->
                                </td>
